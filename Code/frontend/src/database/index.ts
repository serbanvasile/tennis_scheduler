...
// Import the appropriate adapter based on platform
let adapter: any;

if (Platform.OS === 'web') {
  // For web, use LokiJS adapter only
  ...
  // For React Native, dynamically import SQLite adapter
...
// Seed data - we'll populate this on first run
